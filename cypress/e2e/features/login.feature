Feature: Login functionality
    ...
    Scenario: Login with invalid username
        ...
        And I click the login button
        Then I should see login error message "Username and password do not match any user in this service"
    ...
    Scenario: Login with empty fields
        ...
        Then I should see login error message "Username is required"